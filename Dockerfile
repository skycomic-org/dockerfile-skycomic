...
RUN ln -s ../../mods-available/mcrypt.ini /etc/php5/apache2/conf.d/20-mcrypt.ini && \
        ...
        rm -fr /app && git clone --recursive https://github.com/skycomic-org/skycomic.org-backend.git /app && \
        ...
        echo "alias vim=vim.tiny" >> /root/.bashrc && ln -s nodejs /usr/bin/node && \
        npm install -g gulp bower && \
        cd /app/frontend && npm install && bower --allow-root install && gulp
